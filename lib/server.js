      ...
      co(function*() {
        ...
        // console.dir(opt)
          ...
          authenticate(_server, credentials, function(err) {
            ...
            // console.log("--------------------------- executeCommand authenticate")
  ...
  ismaster() {
    ...
    return new Promise(function(resolve, reject) {
      co(function*() {
        ...
        // console.log("------------------------------------- performing ismaster on " + opt.port)
        // console.dir(opt)
        ...
        s.on('connect', function(_server) {
          _server.command('system.$cmd', {
            ...
            // console.log("--------------------------------- ismaster for " + opt.port)
            // console.dir(err)
            // console.dir(r)
            // Destroy the connection
            _server.destroy();
